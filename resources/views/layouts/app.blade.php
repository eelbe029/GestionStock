...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/jquery-roadmap@1.4.0/dist/jquery.roadmap.min.css" rel="stylesheet">
...
<main class="d-flex flex-nowrap">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark position-fixed-start " style="width: 280px;">
        <a href="/" class="d-flex align-items-center mb-3 ms-2 mb-md-0 me-md-auto text-white text-decoration-none">
            <span class="fs-4">Gestion Stock</span>
        </a>
        <hr>
